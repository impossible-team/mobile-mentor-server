...
class GameResults(models.Model):
    ...
    player_1 = models.BooleanField(null=False, blank=False, verbose_name=_('Player 1'))
    player_2 = models.BooleanField(null=False, blank=False, verbose_name=_('Player 2'))
